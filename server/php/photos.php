...
$stmt=$db->prepare("SELECT id, file, width, height, date_creation,comment,device,maker,filesize,ext,path,media_name,md5sum,rotation,latitude,longitude,lastmodified  FROM photobase.photo_images WHERE media_name=:media AND path=:path ORDER BY file");
